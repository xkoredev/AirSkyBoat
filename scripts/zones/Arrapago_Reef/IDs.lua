...
zones[xi.zone.ARRAPAGO_REEF] =
{
    text =
    {
        ...
        YOUR_IMPERIAL_STANDING        = 7918, -- Your Imperial Standing has increased!
        FEEL_A_CHILL                  = 8378, -- You feel a chill run down your spine!
        HAND_OVER_TO_IMMORTAL         = 8436, -- You hand over the % to the Immortal.
        CANNOT_ENTER                  = 8455, -- You cannot enter at this time. Please wait a while before trying again.
        AREA_FULL                     = 8456, -- This area is fully occupied. You were unable to enter.
        MEMBER_NO_REQS                = 8460, -- Not all of your party members meet the requirements for this objective. Unable to enter area.
        MEMBER_TOO_FAR                = 8464, -- One or more party members are too far away from the entrance. Unable to enter area.
        BESIEGED_UPDATES_BASE         = 8485, -- The Mamool Ja Savages are on the move. Intercept their forces in the Wajaom Woodlands!
        MEDUSA_ENGAGE                 = 8566, -- Foolish two-legs... Have you forgotten the terrible power of the gorgons you created? It is time you were reminded...
        MEDUSA_DEATH                  = 8567, -- No... I cannot leave my sisters...
        GLITTERING_FRAGMENTS          = 8890, -- Minute glittering fragments are scattered all over...
        STIFLING_STENCH               = 8903, -- A stifling stench pervades the air...
        SLIMY_TOUCH                   = 8908, -- The ground here is slimy to the touch...
        FLUTTERY_OBJECTS              = 8914, -- Light, fluttery objects litter the ground...
        DRAWS_NEAR                    = 8919, -- Something draws near!
        COMMON_SENSE_SURVIVAL         = 9790, -- It appears that you have arrived at a new survival guide provided by the Adventurers' Mutual Aid Network. Common sense dictates that you should now be able to teleport here from similar tomes throughout the world.
    },
    mob =
    {
        BLOODY_BONES_PH =
